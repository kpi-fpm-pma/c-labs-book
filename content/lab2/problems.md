...
#### Варіант №1
- Вставити після кожного п'ятого елемента масиву А (n) значення, яка дорівнює загальній кількості трьох попередніх елементів.
...
#### Варіант №16
- Дано одновимірний масив A, що складається з n елементів. Визначити найменшу з різниць , де n — парне.
...
#### Варіант №19
- Дано одновимірний масив A, що складається з n елементів. Визначити найменше зі значень .
- Впорядкувати масив методом човникового сортування.
...
- Впорядкувати масив методом човникового сортування.
#### Варіант №26
- Сформувати 2 масиви дійсних чисел: A(n)і B(n). Обчислити (a1+bn)*(a2+bn-1)*…*(an+b1).
...
#### Варіант №28
- Сформувати 2 масиви цілих чисел: A(n)і B(n). Перетворити послідовність b1, b2,…bn за правилом: якщо ai<=0, то bi  збільшити в 10 разів, інакше,  bi замінити нулем.
...
#### Варіант №2*
Дано матриці A й В розмірів k*m і m*l, відповідно. Знайти A * В.
...
#### Варіант №4
Дано матрицю з цілих чисел. Зібрати всі нульові елементи вище за головну діагональ (заповнення здійснювати паралельно головній діагоналі).

#### Варіант №5
Розглядаючи матрицю A(n*n) як складену з чотирьох квадратів, поміняти в ній центрально-симетричні квадрати один з одним місцями.

#### Варіант №6*
Дано матрицю A:
а) розміру m*m;
б) розміру m*n.
Одержати матрицю АА*, де * — операція транспонування (розмір результуючої матриці повинен бути m*m).

#### Варіант №7
Дано матрицю з цілих чисел. Зібрати всі від’ємні елементи вище за побічну діагональ (заповнення здійснювати за рядками).

#### Варіант №8
Знайти всі сідлові точки матриці A(n*m). Матриця має сідлову точку , якщо  є мінімальним елементом в i-му рядку і максимальним елементом у j-му стовпці.

#### Варіант №9*
Дано квадратні матриці А та В порядку n. Одержати матрицю АВ-ВА.

#### Варіант №10
Дано матрицю з цілих чисел. У рядках, усі елементи яких парні, розташувати елементи у зворотному порядку.

#### Варіант №11*
Дано квадратну матрицю А порядку m. Одержати матриці  і , де * — операція транспонування.
...
#### Варіант №13
Дано квадратну матрицю А порядку n. Одержати матрицю А*В, де елементи матриці В обчислюють за формулою: .
...
#### Варіант №18
Розглядаючи матрицю A(n*n) як складену з чотирьох квадратів, поміняти в ній квадрати місцями за годинниковою стрілкою.

#### Варіант №19*
Дано квадратну матрицю А порядку n. Одержати вектор Ab, де елементи вектора b обчислюють за формулою .
...
#### Варіант №21
Задана матриця c (n, n). отримати вектор в, кожен елемент якого дорівнює кількості нулів, що стоять в стовпці матриці.

#### Варіант №22
Задана матриця Q (n, n). Якщо на головній діагоналі стоїть нуль, то
відповідний рядок замінити одиницями.

#### Варіант №23
Задана матриця D (n, n). Якщо максимальний елемент матриці стоїть на головній діагоналі, то всі елементи головної діагоналі зробити рівними максимальному.

#### Варіант №24
Переписати перші елементи кожного рядка матриці D (n, n), які більше 10, в масив В.

#### Варіант №25
Впорядкувати рядки матриці S (n, m), що містять нулі, в порядку зростання їх кількості.

#### Варіант №26
Матриця заповнюється випадковими значеннями за допомогою функції rand (). Розміри матриці задаються за допомогою #define. Підрахувати середнє арифметичне значення і дисперсію в кожному стовпці матриці.

#### Варіант №27
Розташувати по зростанню елементи побічної діагоналі матриці. Еле-менти матриці цілі числа.
...
#### Варіант №30
У цілочисленої матриці (t,m) підрахувати середнє арифметичне значення. Всі елементи матриці, менші середнього арифметичного, замінити на -1, більші - на 1.
