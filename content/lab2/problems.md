...
#### Варіант №2*
Дано матриці $A$ й $В$ розмірів `k x m` і `m x l`, відповідно. Знайти $A * В$.
...
а) розміру `m x m`;
б) розміру `m x n`.
Одержати матрицю $АА^T$, де $T$ — операція транспонування (розмір результуючої матриці повинен бути `m x m`).
...
#### Варіант №11*
Дано квадратну матрицю $А$ порядку `m`. Одержати матриці $\frac{1}{2}(A + A^T)$ і $\frac{1}{2}(A - A^T)$, де $T$ — операція транспонування.
...
#### Варіант №13
Дано квадратну матрицю $А$ порядку `n`. Одержати матрицю $А*В$, де елементи матриці $В$ обчислюють за формулою: $b_{ij} = \frac{1}{i+j-1}$.
...
#### Варіант №19*
Дано квадратну матрицю $А$ порядку `n`. Одержати вектор $A\bar{b}$, де елементи вектора $\bar{b}$ обчислюють за формулою $b_i = \frac{1}{i+2}$.
